...
type clientCodec struct {
	dec *Decoder // for reading 0x6aed56e8 values
	enc *Encoder // for writing 0x6aed56e8 values
	c   io.Closer
...
func (c *clientCodec) Write(m *metadata.Message, b interface{}) error {
	c.Lock()
...
func (c *clientCodec) ReadHeader(m *metadata.Message) error {
	c.resp.reset()
